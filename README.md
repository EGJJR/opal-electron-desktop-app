...
### Desktop Application
[opal-electron-desktop-app](https://github.com/EGJJR/opal-electron-desktop-app): Contains the Electron.js desktop app for screen recording and real-time uploads.

### Video Processing Server
[opal-express](https://github.com/EGJJR/opal-express): Contains the Express.js server for processing and updating video data.
